        ...
        private async void readPropertiesButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (osResponse.Status == ResponseStatus.Success)
                {
                    ...
                    if (pcmInfo.HardwareType == PcmType.P04_Intel)
                    {
                        this.AddUserMessage("**********************************************");
                        this.AddUserMessage("WARNING: P04_Intel Read is EXPERIMENTAL ONLY.");
                        this.AddUserMessage("It may or may not read your P04_Intel correctly. The read will be VERY SLOW.");
                        this.AddUserMessage("If you have the skills please help us improve this code and send us a pull request on github.");
                        this.AddUserMessage("P04_Intel Write is not yet under development, please do not ask when it is ready. P04_Intel read must work well first.");
                        this.AddUserMessage("**********************************************");
                    }
                }
                else
                ...
                // Disable BCC lookup for the P04_Intel
                if (pcmInfo != null && pcmInfo.HardwareType != PcmType.P04_Intel)
                {
            ...
            using (new AwayMode())
            {
                try
                {
                    ...
                    if (pcmInfo.HardwareType == PcmType.P04_Intel)
                    {
                        this.AddUserMessage("WARNING: P04_Intel Read is EXPERIMENTAL ONLY.");
                        this.AddUserMessage("It may or may not read your P04_Intel correctly. The read will be VERY SLOW.");
                        DialogResult dialogResult = MessageBox.Show("WARNING: P04_Intel Read is EXPERIMENTAL ONLY.\nIt may or may not read your P04_Intel correctly.\nThe read will be VERY SLOW.\n", "Continue?", MessageBoxButtons.YesNo);
        ...
        private async void write_BackgroundThread(WriteType writeType, string path = null)
        {
            using (new AwayMode())
            {
                try
                {
                    ...
                    if (pcmInfo.HardwareType == PcmType.P04_Intel)
                    {
                        this.AddUserMessage("P04_Intel Write is not supported by PCMHammer, aborted");
                        MessageBox.Show("P04_Intel Write is not supported by PCMHammer");
                        return;
                    }
